...
**analysis of domiance: respondents athat always state the hob with the higher attribute**


**partial log-likelihood analysis ranking of importance of attirbutes**
